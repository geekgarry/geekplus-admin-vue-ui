...
<script>
import { getListTableInfo, getAllListTableInfo, getTableInfo, listGenTable, getGenTable, delGenTable, cleanGenTable, modifyGenTable, addGenTable, genAddGenTableInfo, downloadCode, downloadByGenTable } from "@/api/tool/generatorTable"
