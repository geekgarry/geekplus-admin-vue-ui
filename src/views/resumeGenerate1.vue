<template>
  <el-container>
    <el-header>
      <el-row>
        <el-col align="center">简历制作工具</el-col>
      </el-row>
    </el-header>
    <el-main>
      <div class="app-container">
        ...
        <!--        <el-input-->
        <!--          v-model="queryParams.jobIntention"-->
        <!--          placeholder="请输入求职意向"-->
        <!--          clearable-->
        <!--          size="small"-->
        <!--          @keyup.enter.native="handleQuery"-->
        ...
        <!--        <el-input-->
        <!--          v-model="queryParams.unSpecializedSubject"-->
        <!--          placeholder="请输入学习专业"-->
        <!--          clearable-->
        <!--          size="small"-->
        <!--          @keyup.enter.native="handleQuery"-->
        ...
        <!--        <el-input-->
        <!--          v-model="queryParams.masterLanguage"-->
        <!--          placeholder="请输入掌握语言"-->
        <!--          clearable-->
        <!--          size="small"-->
        <!--          @keyup.enter.native="handleQuery"-->
        ...
        <!--        <el-input-->
        <!--          v-model="queryParams.officeSkill"-->
        <!--          placeholder="请输入办公技能"-->
        <!--          clearable-->
        <!--          size="small"-->
        <!--          @keyup.enter.native="handleQuery"-->
        ...
        >
          ...
          <el-table-column label="我的简历" align="center">
            <el-table-column
              label="求职意向"
              align="center"
              prop="jobIntention"
            ...
            <el-table-column label="基本信息" align="center">
              <!--              <el-table-column label="昵称" align="center" prop="nickName" width="130" >-->
              <!--                &lt;!&ndash;            <template slot-scope="scope">&ndash;&gt;-->
              <!--                &lt;!&ndash;              <span >{{scope.row.resumeList.nickName}}</span>&ndash;&gt;-->
              ...
              >
                <template slot-scope="scope">
                  ...
                  <span
                    v-if="scope.row.gender == null || scope.row.gender == ''"
                    >未知</span
                  >
                </template>
              </el-table-column>
        ...
        <el-table :data="resumeList">
          <el-table-column label="个人介绍与自我评价" align="center">
            <el-table-column
              label="个人简介"
              align="center"
              prop="personalIntroduce"
            />
            <el-table-column
              label="自我评价"
              align="center"
        ...
        <el-table :data="resumeList">
          <el-table-column label="教育信息" align="center">
            <el-table-column
              label="学历"
              align="center"
              prop="education"
            ...
            <el-table-column
              label="大学所学专业"
              align="center"
              prop="unSpecializedSubject"
              :show-overflow-tooltip="true"
            />
          </el-table-column>
        </el-table>
        <el-table :data="resumeList">
          <el-table-column label="我的学习课程" align="center">
            <el-table-column
              label="教育时间"
              align="center"
              prop="universityStudyTime"
              width="200"
              :show-overflow-tooltip="true"
            />
            <el-table-column
              label="大学主要学习课程"
              align="center"
              prop="unMainCoursesStudy"
            />
          </el-table-column>
        </el-table>
        <el-table :data="resumeList">
          <el-table-column label="相关技能" align="center">
            <el-table-column
              label="掌握语言"
              align="center"
              prop="masterLanguage"
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                type="primary"
                icon="el-icon-view"
                @click="viewResumeDetail(scope.row)"
                >生成简历模板</el-button
              >
              <el-button
                round
              ...
              <el-button
                ...
                type="success"
                icon="el-icon-check"
                @click="listTechnology(scope.row)"
                >查看技术技能</el-button
              >
            </template>
          </el-table-column>
