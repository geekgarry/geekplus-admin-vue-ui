<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="询问内容" align="center" prop="askContent" width="180" :show-overflow-tooltip="true" />
      <el-table-column label="回复内容" align="center" prop="replyContent" width="180" :show-overflow-tooltip="true" />
