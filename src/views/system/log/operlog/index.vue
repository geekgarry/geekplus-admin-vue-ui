    ...
    >
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="操作浏览器：">{{ form.operBrowser }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="操作系统：">{{ form.operOs }}</el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
import { listOperLog, delOperlog, cleanOperlog, exportOperlog } from "@/api/system/log/operlog";
