<template>
  <div class="dashboard-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          <h2>
            <el-link href="https://www.geekplus.xyz" type="info" target="_blank"
              >极客普拉斯</el-link
            >
          </h2>
          <el-button class="mobile" type="primary" icon="el-icon-document"
            ><el-link
              target="_blank"
              type="info"
              href="http://resume.geekcjj.top"
              >我的在线网页简历</el-link
            ></el-button
          >
          <br />
          <el-link
            ...
            type="primary"
            target="_blank"
            >https://www.geekplus.xyz</el-link
          >
          <br />
          极客普拉斯
          <br />
          ...
          极客普拉斯后端
          <el-link
            href="https://github.com/geekgarry/geekplus-admin-shiro"
            type="primary"
            target="_blank"
            >>☛☛点我进入☚☚</el-link
          >
          &nbsp;&nbsp;&nbsp; 极客普拉斯前端
          <el-link
            href="https://github.com/geekgarry/geekplus-admin-vue"
            type="primary"
            target="_blank"
            >>☛☛点我进入☚☚</el-link
          ><br />
          <h4 class="text-danger">极客普拉斯</h4>
        </blockquote>
    ...
    <el-row :gutter="20">
      <el-col :sm="12" :lg="12" :md="12" style="padding-left: 20px">
      ...
      <el-col :xs="24" :sm="12" :md="12" :lg="12" style="padding-left: 20px">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>二维码生成</span>
            <el-button style="float: right; padding: 3px 0" type="text"
          ...
          <div>
            <el-form
              ...
              class="demo-ruleForm"
            >
              <el-form-item prop="qrCodeText">
                <el-input
                  placeholder="请输入要生成的文本"
                  v-model="qrCodeText"
                  @keyup.enter.native="getQRCodeImg"
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>麦壳后台管理框架</h2>
        <p>
          一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套后台系统。如此有了极客普拉斯管理系统。他可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            plain
            @click="
              goTarget('https://github.com/geekgarry/geekplus-admin-vue.git')
            "
            >访问Github</el-button
          >
          <el-button
            ...
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://www.geekplus.xyz')"
            >访问主页</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            ...
            <span v-for="(item, index) in noticeList" :key="index">
              <p>
                ...
                ><el-link :href="item.noticeUrl" target="_blank">{{
                  item.noticeTitle
                }}</el-link>
              </p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            <img
              src="https://www.geekplus.xyz/imgs/earnmoney/alipay.jpg"
              alt="donate"
              width="50%"
            />
            <img
              src="https://www.geekplus.xyz/imgs/earnmoney/wxpay.jpg"
              alt="donate"
              width="50%"
            />
            <span style="display: inline-block; height: 30px; line-height: 30px"
              >你可以请作者喝杯奶茶表示鼓励和支持</span
            >
          </div>
        </el-card>
      </el-col>
  ...
  methods: {
    ...
    getQRCodeImg() {
      getQRCodeImg(this.qrCodeText).then((res) => {
        this.qrCodeImg = "data:image/gif;base64," + res.data;
